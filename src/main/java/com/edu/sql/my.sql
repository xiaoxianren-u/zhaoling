...
VALUES ('了解招物', DEFAULT, 1, DEFAULT),
       ('普通用户', DEFAULT, 2, DEFAULT),
       ('后台管理员', DEFAULT, 2, DEFAULT),
       ('角色管理', DEFAULT, 2, DEFAULT),
       ('用户黑名单', DEFAULT, 2, DEFAULT),
       ('帖子管理', DEFAULT, 3, DEFAULT),
       ('发布帖子', DEFAULT, 3, DEFAULT),
       ('寻物帖子', DEFAULT, 3, DEFAULT),
       ('帖子举报', DEFAULT, 3, DEFAULT),
       ('物品状态', DEFAULT, 3, DEFAULT),
       ('帖子分类', DEFAULT, 3, DEFAULT),
       ('发表感谢', DEFAULT, 3, DEFAULT),
       ('通知公告', DEFAULT, 4, DEFAULT),
       ('意见与反馈', DEFAULT, 4, DEFAULT),
       ('用户消息', DEFAULT, 4, DEFAULT),
       ('操作日志', DEFAULT, 5, DEFAULT),
       ('登录日志', DEFAULT, 5, DEFAULT),
       ('基本资料', DEFAULT, 6, DEFAULT),
       ('修改密码', DEFAULT, 6, DEFAULT);
...
CREATE TABLE notify_db(
                          ...
                          PRIMARY KEY (noti_id)
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT 'notify';
...
CREATE TABLE grate_ful_db(
                             ...
                             PRIMARY KEY (gra_id)
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT 'grate_ful_db';
...
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT 'label_db';
# 帖子表
...
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT 'post_db';
...
)ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT 'picture';
